 ! function () {
     ...
     var t = "undefined" != typeof window && "undefined" != typeof window.document ? window.document : {},
         ...
         s = {
             request: function (e) {
                 ...
                 e = e || t.documentElement, / Version\/5\.1(?:\.\d+)? Safari\//.test(navigator.userAgent) ? e[o]() : e[o](n ? Element.ALLOW_KEYBOARD_INPUT : {})
             },
             exit: function () {
                 t[i.exitFullscreen]()
             },
     ...
     return i ? (Object.defineProperties(s, {
         isFullscreen: {
             get: function () {
     ...
     }), void(e ? module.exports = s : window.screenfull = s)) : void(e ? module.exports = !1 : window.screenfull = !1)
 }(),
 function (t) {
     function e() {
         var t = a();
     ...
     t.isTouchCapable = function () {
     ...
     }, t.each(["tapstart", "tapend", "tapmove", "tap", "tap2", "tap3", "tap4", "singletap", "doubletap", "taphold", "swipe", "swipeup", "swiperight", "swipedown", "swipeleft", "swipeend", "scrollstart", "scrollend", "orientationchange"], function (e, n) {
         t.fn[n] = function (t) {
             ...
             i.on(o.startevent, function s(t) {
                 ...
                 var a = t.originalEvent,
                     r = {
                         ...
                         offset: {
                             x: o.touch_capable ? Math.round(a.changedTouches[0].pageX - (i.offset() ? i.offset().left : 0)) : Math.round(t.pageX - (i.offset() ? i.offset().left : 0)),
                             y: o.touch_capable ? Math.round(a.changedTouches[0].pageY - (i.offset() ? i.offset().top : 0)) : Math.round(t.pageY - (i.offset() ? i.offset().top : 0))
                         },
                         time: Date.now(),
                         target: t.target
                     };
         ...
         setup: function () {
             ...
             s.on(o.startevent, function c(t) {
                 ...
                 var l = t.originalEvent,
                     ...
                     d = {
                         x: o.touch_capable ? l.touches[0].pageX - l.touches[0].target.offsetLeft : t.offsetX,
                         y: o.touch_capable ? l.touches[0].pageY - l.touches[0].target.offsetTop : t.offsetY
                     };
                 a.x = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageX : t.pageX, a.y = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageY : t.pageY, r = a.x, h = a.y;
                 var p = s.parent().data("threshold") ? s.parent().data("threshold") : s.data("threshold"),
                     g = "undefined" != typeof p && p !== !1 && parseInt(p) ? parseInt(p) : o.taphold_threshold;
                 return o.hold_timer = window.setTimeout(function () {
                     var p = a.x - r,
                         g = a.y - h;
                     if (t.target == e && (a.x == r && a.y == h || p >= -o.tap_pixel_range && p <= o.tap_pixel_range && g >= -o.tap_pixel_range && g <= o.tap_pixel_range)) {
                         s.data("tapheld", !0);
                         var m = Date.now(),
                             v = {
                                 x: o.touch_capable ? l.touches[0].screenX : t.screenX,
                             ...
                             y = {
                                 x: o.touch_capable ? Math.round(l.changedTouches[0].pageX - (s.offset() ? s.offset().left : 0)) : Math.round(t.pageX - (s.offset() ? s.offset().left : 0)),
                                 y: o.touch_capable ? Math.round(l.changedTouches[0].pageY - (s.offset() ? s.offset().top : 0)) : Math.round(t.pageY - (s.offset() ? s.offset().top : 0))
                             },
                             w = m - u,
                             b = {
                                 startTime: u,
                 ...
                 s.data("callee2", l), s.data("tapheld", !1), window.clearTimeout(o.hold_timer)
             }).on(o.moveevent, function u(t) {
                 s.data("callee3", u), r = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageX : t.pageX, h = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageY : t.pageY
             })
         },
         remove: function () {
         ...
         setup: function () {
             ...
             h.on(o.startevent, function u(n) {
                 return n.which && 1 !== n.which ? !1 : (h.data("doubletapped", !1), e = n.target, h.data("callee1", u), s = n.originalEvent, c || (c = {
                     position: {
                         x: o.touch_capable ? s.touches[0].screenX : n.screenX,
                         y: o.touch_capable ? s.touches[0].screenY : n.screenY
                     },
                     offset: {
                         x: o.touch_capable ? Math.round(s.changedTouches[0].pageX - (h.offset() ? h.offset().left : 0)) : Math.round(n.pageX - (h.offset() ? h.offset().left : 0)),
                         y: o.touch_capable ? Math.round(s.changedTouches[0].pageY - (h.offset() ? h.offset().top : 0)) : Math.round(n.pageY - (h.offset() ? h.offset().top : 0))
                     },
                     time: Date.now(),
                     target: n.target,
                 ...
                 var u = Date.now(),
                     ...
                     p = u - d;
                 if (window.clearTimeout(i), h.data("callee2", f), p < o.doubletap_int && t(e.target).index() == c.index && p > 100) {
                     ...
                     var g = {
                             ...
                             offset: {
                                 x: o.touch_capable ? Math.round(s.changedTouches[0].pageX - (h.offset() ? h.offset().left : 0)) : Math.round(e.pageX - (h.offset() ? h.offset().left : 0)),
                                 y: o.touch_capable ? Math.round(s.changedTouches[0].pageY - (h.offset() ? h.offset().top : 0)) : Math.round(e.pageY - (h.offset() ? h.offset().top : 0))
                             },
                             time: Date.now(),
                             target: e.target,
                     ...
                     l || (n(r, "doubletap", e, m), c = null), l = !0, a = window.setTimeout(function () {
                         l = !1
                     }, o.doubletap_int)
                 } else h.data("lastTouch", u), i = window.setTimeout(function () {
         ...
         setup: function () {
             ...
             i.on(o.startevent, function h(t) {
                 return t.which && 1 !== t.which ? !1 : (a = Date.now(), s = t.target, i.data("callee1", h), r.x = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageX : t.pageX, r.y = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageY : t.pageY, !0)
                 ...
                 if (i.data("callee2", c), t.target == s) {
                     ...
                     o.tap_timer = window.setTimeout(function () {
                         var s = r.x - h,
                             c = r.y - l;
                         if (!i.data("doubletapped") && !i.data("tapheld") && (r.x == h && r.y == l || s >= -o.tap_pixel_range && s <= o.tap_pixel_range && c >= -o.tap_pixel_range && c <= o.tap_pixel_range)) {
                             var u = t.originalEvent,
                                 f = {
                                     position: {
                                         x: o.touch_capable ? u.changedTouches[0].screenX : t.screenX,
                                         y: o.touch_capable ? u.changedTouches[0].screenY : t.screenY
                                     },
                                     offset: {
                                         x: o.touch_capable ? Math.round(u.changedTouches[0].pageX - (i.offset() ? i.offset().left : 0)) : Math.round(t.pageX - (i.offset() ? i.offset().left : 0)),
                                         y: o.touch_capable ? Math.round(u.changedTouches[0].pageY - (i.offset() ? i.offset().top : 0)) : Math.round(t.pageY - (i.offset() ? i.offset().top : 0))
                                     },
                                     time: Date.now(),
                                     target: t.target
                                 };
         ...
         setup: function () {
             ...
             a.on(o.startevent, function l(t) {
                 return a.data("callee1", l), t.which && 1 !== t.which ? !1 : (r = !0, c.x = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageX : t.pageX, c.y = t.originalEvent.targetTouches ? t.originalEvent.targetTouches[0].pageY : t.pageY, e = Date.now(), h = t.target, i = t.originalEvent.targetTouches ? t.originalEvent.targetTouches : [t], !0)
                 ...
                 var l = t.originalEvent.targetTouches ? t.originalEvent.changedTouches[0].pageX : t.pageX,
                     ...
                     d = c.x - l,
                     p = c.y - f;
                 if (h == t.target && r && Date.now() - e < o.taphold_threshold && (c.x == l && c.y == f || d >= -o.tap_pixel_range && d <= o.tap_pixel_range && p >= -o.tap_pixel_range && p <= o.tap_pixel_range)) {
                     for (var g = t.originalEvent, m = [], v = 0; v < i.length; v++) {
                         var y = {
                             position: {
                                 x: o.touch_capable ? g.changedTouches[v].screenX : t.screenX,
                                 y: o.touch_capable ? g.changedTouches[v].screenY : t.screenY
                             },
                             offset: {
                                 x: o.touch_capable ? Math.round(g.changedTouches[v].pageX - (a.offset() ? a.offset().left : 0)) : Math.round(t.pageX - (a.offset() ? a.offset().left : 0)),
                                 y: o.touch_capable ? Math.round(g.changedTouches[v].pageY - (a.offset() ? a.offset().top : 0)) : Math.round(t.pageY - (a.offset() ? a.offset().top : 0))
                             },
                             time: Date.now(),
                             target: t.target
                         };
         ...
         setup: function () {
             function e(n) {
                 r = t(n.currentTarget), r.data("callee1", e), l.x = n.originalEvent.targetTouches ? n.originalEvent.targetTouches[0].pageX : n.pageX, l.y = n.originalEvent.targetTouches ? n.originalEvent.targetTouches[0].pageY : n.pageY, u.x = l.x, u.y = l.y, h = !0;
                 ...
                 s = {
                     ...
                     offset: {
                         x: o.touch_capable ? Math.round(i.changedTouches[0].pageX - (r.offset() ? r.offset().left : 0)) : Math.round(n.pageX - (r.offset() ? r.offset().left : 0)),
                         y: o.touch_capable ? Math.round(i.changedTouches[0].pageY - (r.offset() ? r.offset().top : 0)) : Math.round(n.pageY - (r.offset() ? r.offset().top : 0))
                     },
                     time: Date.now(),
                     target: n.target
                 }
             ...
             function n(e) {
                 r = t(e.currentTarget), r.data("callee2", n), u.x = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageX : e.pageX, u.y = e.originalEvent.targetTouches ? e.originalEvent.targetTouches[0].pageY : e.pageY;
                 var i, a = r.parent().data("xthreshold") ? r.parent().data("xthreshold") : r.data("xthreshold"),
                     f = r.parent().data("ythreshold") ? r.parent().data("ythreshold") : r.data("ythreshold"),
                     d = "undefined" != typeof a && a !== !1 && parseInt(a) ? parseInt(a) : o.swipe_h_threshold,
                     p = "undefined" != typeof f && f !== !1 && parseInt(f) ? parseInt(f) : o.swipe_v_threshold;
                 if (l.y > u.y && l.y - u.y > p && (i = "swipeup"), l.x < u.x && u.x - l.x > d && (i = "swiperight"), l.y < u.y && u.y - l.y > p && (i = "swipedown"), l.x > u.x && l.x - u.x > d && (i = "swipeleft"), void 0 != i && h) {
                     ...
                     var g = e.originalEvent,
                         m = {
                             ...
                             offset: {
                                 x: o.touch_capable ? Math.round(g.changedTouches[0].pageX - (r.offset() ? r.offset().left : 0)) : Math.round(e.pageX - (r.offset() ? r.offset().left : 0)),
                                 y: o.touch_capable ? Math.round(g.changedTouches[0].pageY - (r.offset() ? r.offset().top : 0)) : Math.round(e.pageY - (r.offset() ? r.offset().top : 0))
                             },
                             time: Date.now(),
                             target: e.target
                         },
             ...
             function i(e) {
                 ...
                 if (r.data("callee3", i), c) {
                     var a = r.data("xthreshold"),
                         l = r.data("ythreshold"),
                         u = "undefined" != typeof a && a !== !1 && parseInt(a) ? parseInt(a) : o.swipe_h_threshold,
                         f = "undefined" != typeof l && l !== !1 && parseInt(l) ? parseInt(l) : o.swipe_v_threshold,
                         d = e.originalEvent,
                         p = {
                             position: {
                                 x: o.touch_capable ? d.changedTouches[0].screenX : e.screenX,
                                 y: o.touch_capable ? d.changedTouches[0].screenY : e.screenY
                             },
                             offset: {
                                 x: o.touch_capable ? Math.round(d.changedTouches[0].pageX - (r.offset() ? r.offset().left : 0)) : Math.round(e.pageX - (r.offset() ? r.offset().left : 0)),
                                 y: o.touch_capable ? Math.round(d.changedTouches[0].pageY - (r.offset() ? r.offset().top : 0)) : Math.round(e.pageY - (r.offset() ? r.offset().top : 0))
                             },
                             time: Date.now(),
                             target: e.target
                         };
                     s.position.y > p.position.y && s.position.y - p.position.y > f && (n = "swipeup"), s.position.x < p.position.x && p.position.x - s.position.x > u && (n = "swiperight"), s.position.y < p.position.y && p.position.y - s.position.y > f && (n = "swipedown"), s.position.x > p.position.x && s.position.x - p.position.x > u && (n = "swipeleft");
         ...
         setup: function () {
             ...
             r.on(o.scrollevent, function h(t) {
                 r.data("callee", h), i || e(t, !0), clearTimeout(s), s = setTimeout(function () {
                     e(t, !1)
                 }, 50)
             })
         },
     ...
     if (o.orientation_support) {
         var f = window.innerWidth || l.width(),
             ...
             p = 50;
         h = f > d && f - d > p, c = u[window.orientation], (h && c || !h && !c) && (u = {
             "-90": !0,
             90: !0
         })
     }
     t.event.special.orientationchange = s = {
         setup: function () {
             return o.orientation_support ? !1 : (r = a(), l.on("throttledresize", e), !0)
         },
         teardown: function () {
         ...
         return t = o.orientation_support ? u[window.orientation] : e && e.clientWidth / e.clientHeight < 1.1, t ? "portrait" : "landscape"
     ...
     var g, m, v, y = 250,
         w = function () {
             m = Date.now(), v = m - b, v >= y ? (b = m, t(this).trigger("throttledresize")) : (g && window.clearTimeout(g), g = window.setTimeout(e, y - v))
         },
         b = 0;
     t.each({
 ...
 function (t) {
     t.easing.jswing = t.easing.swing, t.extend(t.easing, {
         ...
         easeInOutElastic: function (t, e, n, i, o) {
             ...
             return 1 > e ? -.5 * (r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * o - s) * (2 * Math.PI) / a)) + n : r * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * o - s) * (2 * Math.PI) / a) * .5 + i + n
         },
         ...
         easeInOutBounce: function (e, n, i, o, s) {
             return s / 2 > n ? .5 * t.easing.easeInBounce(e, 2 * n, 0, o, s) + i : .5 * t.easing.easeOutBounce(e, 2 * n - s, 0, o, s) + .5 * o + i
         }
     })
 }(jQuery),
 function (t) {
     ...
     function e(e) {
         var a = e || window.event,
             ...
             u = 0,
             f = 0;
         if (e = t.event.fix(a), e.type = "mousewheel", "detail" in a && (u = -1 * a.detail), "wheelDelta" in a && (u = a.wheelDelta), "wheelDeltaY" in a && (u = a.wheelDeltaY), "wheelDeltaX" in a && (l = -1 * a.wheelDeltaX), "axis" in a && a.axis === a.HORIZONTAL_AXIS && (l = -1 * u, u = 0), c = 0 === u ? l : u, "deltaY" in a && (u = -1 * a.deltaY, c = u), "deltaX" in a && (l = a.deltaX, 0 === u && (c = -1 * l)), 0 !== u || 0 !== l) {
             if (1 === a.deltaMode) {
             ...
             return f = Math.max(Math.abs(u), Math.abs(l)), (!s || s > f) && (s = f, i(a, f) && (s /= 40)), i(a, f) && (c /= 40, l /= 40, u /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / s), l = Math[l >= 1 ? "floor" : "ceil"](l / s), u = Math[u >= 1 ? "floor" : "ceil"](u / s), e.deltaX = l, e.deltaY = u, e.deltaFactor = s, e.deltaMode = 0, r.unshift(e, c, l, u), o && clearTimeout(o), o = setTimeout(n, 200), (t.event.dispatch || t.event.handle).apply(this, r)
         }
     }
 ...
 function (t) {
     ...
     t.fn.rotate = function (i) {
         var o, s = t(this),
             a = e(s);
         return "undefined" == typeof i ? a.rotate + a.rotateUnits : (o = i.toString().match(/^(-?\d+(\.\d+)?)(.+)?$/), o && (o[3] && (a.rotateUnits = o[3]), a.rotate = o[1], n(s, a)), this)
     }, t.fn.scale = function (i) {
         var o = t(this),
             s = e(o);
         return "undefined" == typeof i ? s.scale : (s.scale = i, n(o, s), this)
     };
     var i = t.fx.prototype.cur;
     t.fx.prototype.cur = function () {
         return "rotate" == this.prop ? parseFloat(t(this.elem).rotate()) : "scale" == this.prop ? parseFloat(t(this.elem).scale()) : i.apply(this, arguments)
     ...
     t.fn.animate = function (n) {
         if ("undefined" != typeof n.rotate) {
             var i, s, a = n.rotate.toString().match(/^(([+-]=)?(-?\d+(\.\d+)?))(.+)?$/);
             a && a[5] && (i = t(this), s = e(i), s.rotateUnits = a[5]), n.rotate = a[1]
         }
 ...
 function (t) {
     ...
     var n = function () {
         ...
         i = function (e, n) {
             return this.settings = n, this.el = e, this.$el = t(e), this._initElements(), this
         };
     i.DATA_KEY = "draptouch", i.DEFAULTS = {
         cursor: "",
         decelerate: !0,
         triggerHardware: !0,
         threshold: 0,
         ...
         this.settings.events = {
             ...
             scroll: function (n) {
                 t.isFunction(e.settings.moved) && e.settings.moved.call(e, e.settings), n.preventDefault && n.preventDefault()
             },
         ...
         if ((!this.lastMove || new Date > new Date(this.lastMove.getTime() + this.throttleTimeout)) && (this.lastMove = new Date, this.mouseDown && (this.xpos || this.ypos))) {
             ...
             var r = this.scrollLeft(),
                 h = this.scrollTop();
             this.scrollLeft(this.settings.x ? r - o : r), this.scrollTop(this.settings.y ? h - s : h), this.prevXPos = this.xpos, this.prevYPos = this.ypos, this.xpos = e, this.ypos = n, this._calculateVelocities(), this._setMoveClasses(this.settings.movingClass), t.isFunction(this.settings.moved) && this.settings.moved.call(this, this.settings)
         }
         ...
         return t.isFunction(this.settings.filterTarget) ? this.settings.filterTarget.call(this, e, n) !== !1 : !0
     }, i.prototype._threshold = function (e, n) {
         return t.isFunction(this.settings.threshold) ? this.settings.threshold.call(this, e, n) : this.settings.threshold
         ...
         return this.each(function () {
             ...
             s || o.data(i.DATA_KEY, s = new i(this, a)), "string" == typeof e && s[e](n)
         })
     }
         ...
         i = function () {
             ...
             t.prototype = {
                 ...
                 handleDragStart: function (t) {
                     n(this.el, this.options.dragStartEventName), this.stopAnimation(), this.lastDragPosition = !1, this.hasInteraction = !0, this.handleDrag(t)
                 },
                 ...
                 handleZoomStart: function () {
                     n(this.el, this.options.zoomStartEventName), this.stopAnimation(), this.lastScale = 1, this.nthZoom = 0, this.lastZoomCenter = !1, this.hasInteraction = !0
                 },
                 ...
                 handleDoubleTap: function (t) {
                     ...
                     this.hasInteraction || (this.isDoubleTap = !0, o > i && (e = this.getCurrentZoomCenter()), this.animate(this.options.animationDuration, s, this.swing), n(this.el, this.options.doubleTapEventName))
                 },
                         ...
                         s = function () {
                             if (this.inAnimation) {
                                 var a = (new Date).getTime() - o,
                                     r = a / t;
                                 a >= t ? (e(1), i && i(), this.update(), this.stopAnimation(), this.update()) : (n && (r = n(r)), e(r), this.update(), requestAnimationFrame(s))
                             }
                         }.bind(this);
                 ...
                 bindEvents: function () {
                     var t = this;
                     s(this.container, this), window.addEventListener("resize", this.update.bind(this)), Array.from(this.el.querySelectorAll("img")).forEach(function (e) {
                 ...
                 update: function (t) {
                     this.updatePlaned || (this.updatePlaned = !0, window.setTimeout(function () {
                         ...
                         var e = this.getInitialZoomFactor() * this.zoomFactor,
                             ...
                             s = "scale(" + e + ", " + e + ") translate(" + n + "px," + i + "px)",
                             a = function () {
             ...
             var s = function (t, e) {
                 var n = null,
                     ...
                     f = function (t) {
                         ...
                         if (i > 1 && (o = null), 300 > s - o) switch (u(t), e.handleDoubleTap(t), n) {
                             case "zoom":
                                 e.handleZoomEnd(t);
                                 break;
                             case "drag":
 ...
 function (t, e) {
     ...
     function o(t, n, i, o, s, a, r, h, c) {
         "array" === e.type(t) ? this.elements = [+t[0], +t[2], +t[4], +t[1], +t[3], +t[5], 0, 0, 1] : this.elements = [t, n, i, o, s, a, r || 0, h || 0, c || 1]
     }
     ...
     function a(t, n) {
         ...
         var o = this.$elem = e(t);
         this.$set = n.$set && n.$set.length ? n.$set : o, this.$doc = e(t.ownerDocument || r), this.$parent = o.parent(), this.parent = this.$parent[0], this.isSVG = f.test(t.namespaceURI) && "svg" !== t.nodeName.toLowerCase(), this.panning = !1, this._buildTransform(), this._buildTransition(), this.resetDimensions();
         var s = e(),
             c = this;
     ...
     var r = t.document,
         ...
         d = "(\\-?\\d[\\d\\.e-]*)",
         p = "\\,?\\s*",
         g = new RegExp("^matrix\\(" + d + p + d + p + d + p + d + p + d + p + d + "\\)$");
     return o.prototype = {
         x: function (t) {
             var e = t instanceof s,
                 n = this.elements,
                 i = t.elements;
             return e && 3 === i.length ? new s(n[0] * i[0] + n[1] * i[1] + n[2] * i[2], n[3] * i[0] + n[4] * i[1] + n[5] * i[2], n[6] * i[0] + n[7] * i[1] + n[8] * i[2]) : i.length === n.length ? new o(n[0] * i[0] + n[1] * i[3] + n[2] * i[6], n[0] * i[1] + n[1] * i[4] + n[2] * i[7], n[0] * i[2] + n[1] * i[5] + n[2] * i[8], n[3] * i[0] + n[4] * i[3] + n[5] * i[6], n[3] * i[1] + n[4] * i[4] + n[5] * i[7], n[3] * i[2] + n[4] * i[5] + n[5] * i[8], n[6] * i[0] + n[7] * i[3] + n[8] * i[6], n[6] * i[1] + n[7] * i[4] + n[8] * i[7], n[6] * i[2] + n[7] * i[5] + n[8] * i[8]) : !1
         },
         inverse: function () {
             var t = 1 / this.determinant(),
                 e = this.elements;
             return new o(t * (e[8] * e[4] - e[7] * e[5]), t * -(e[8] * e[1] - e[7] * e[2]), t * (e[5] * e[1] - e[4] * e[2]), t * -(e[8] * e[3] - e[6] * e[5]), t * (e[8] * e[0] - e[6] * e[2]), t * -(e[5] * e[0] - e[3] * e[2]), t * (e[7] * e[3] - e[6] * e[4]), t * -(e[7] * e[0] - e[6] * e[1]), t * (e[4] * e[0] - e[3] * e[1]))
         },
         ...
         setTransform: function (t) {
             for (var n = this.$set, i = n.length; i--;) e.style(n[i], "transform", t), this.isSVG && n[i].setAttribute("transform", t)
         },
         getTransform: function (t) {
             var n = this.$set,
                 i = n[0];
             return t ? this.setTransform(t) : (t = e.style(i, "transform"), !this.isSVG || t && "none" !== t || (t = e.attr(i, "transform") || "none")), "none" === t || g.test(t) || this.setTransform(t = e.css(i, "transform")), t || "none"
         },
         ...
         setMatrix: function (t, n) {
             if (!this.disabled) {
                 ...
                 var i = +t[0],
                     o = "undefined" != typeof n.contain ? n.contain : this.options.contain;
                 if (o) {
                     var s = n.dims;
                     s || (this.resetDimensions(), s = this.dimensions);
                     var a, r, h, c = this.container,
                         l = s.width,
                         u = s.height,
                         f = c.width,
                         d = c.height,
                         p = f / l,
                         g = d / u;
                     "center" !== this.$parent.css("textAlign") || "inline" !== e.css(this.elem, "display") ? (h = (l - this.elem.offsetWidth) / 2, a = h - s.border.left, r = l - f - h + s.border.right) : a = r = (l - f) / 2;
                     var m = (u - d) / 2 + s.border.top,
                         v = (u - d) / 2 - s.border.top - s.border.bottom;
                     "invert" === o || "automatic" === o && 1.01 > p ? t[4] = Math.max(Math.min(t[4], a - s.border.left), -r) : t[4] = Math.min(Math.max(t[4], a), -r), "invert" === o || "automatic" === o && 1.01 > g ? t[5] = Math.max(Math.min(t[5], m - s.border.top), -v) : t[5] = Math.min(Math.max(t[5], m), -v)
                 }
                 ...
                 return this.setTransform("matrix(" + t.join(",") + ")"), this.scale = i, this._checkPanWhenZoomed(i), n.silent || this._trigger("change", t), t
             }
         },
         isPanning: function () {
             return this.panning
         ...
         transition: function (t) {
             if (this._transition)
                 for (var n = t || !this.options.transition ? "none" : this._transition, i = this.$set, o = i.length; o--;) e.style(i[o], "transition") !== n && e.style(i[o], "transition", n)
         },
         pan: function (t, e, n) {
         ...
         zoom: function (t, n) {
             ...
             if (!i.disableZoom) {
                 var a = !1,
                     ...
                     h = +r[0];
                 "number" != typeof t && (t = i.linearZoom ? h + i.increment * (t ? -1 : 1) : t ? h / (1 + i.increment) : h * (1 + i.increment), a = !0), t = Math.max(Math.min(t, i.maxScale), i.minScale);
                 var c = i.focal;
                 if (c && !i.disablePan) {
                     ...
                     var d = new s(u, f, 1),
                         ...
                         m = new o(1, 0, g.left - this.$doc.scrollLeft(), 0, 1, g.top - this.$doc.scrollTop()),
                         v = p.inverse().x(m.inverse().x(d)),
                         y = t / r[0];
                     p = p.x(new o([y, 0, 0, y, 0, 0])), d = m.x(p.x(v)), r[4] = +r[4] + (u - d.e(0)), r[5] = +r[5] + (f - d.e(1))
                 }
         ...
         _bind: function () {
             var t = this,
                 ...
                 s = "touchstart" + i + " " + o,
                 r = "touchend" + i + " click" + i + " pointerup" + i + " MSPointerUp" + i,
                 h = {},
                 c = this.$reset,
                 l = this.$zoomRange;
             if (e.each(["Start", "Change", "Zoom", "Pan", "End", "Reset"], function () {
                 ...
                 }), n.disablePan && n.disableZoom || (h[s] = function (e) {
                     var i;
                     ("touchstart" === e.type ? !(i = e.touches || e.originalEvent.touches) || (1 !== i.length || n.disablePan) && 2 !== i.length : n.disablePan || (e.which || e.originalEvent.which) !== n.which) || (e.preventDefault(), e.stopPropagation(), t._startMove(e, i))
                 }, 3 === n.which && (h.contextmenu = !1)), this.$elem.on(h), c.length && c.on(r, function (e) {
                     e.preventDefault(), t.reset()
                 }), l.length && l.attr({
                     step: n.rangeStep === a.defaults.rangeStep && l.attr("step") || n.rangeStep,
                     min: n.minScale,
                     max: n.maxScale
                 }).prop({
                 ...
                 var f = this.$zoomIn,
                     d = this.$zoomOut;
                 f.length && d.length && (f.on(r, function (e) {
                     e.preventDefault(), t.zoom()
                 }), d.on(r, function (e) {
                     e.preventDefault(), t.zoom(!0)
                 })), l.length && (h = {}, h[o] = function () {
                     t.transition(!0)
         ...
         _startMove: function (t, i) {
             if (!this.panning) {
                 var o, s, a, h, c, l, u, f, d = this,
                     ...
                     x = t.type;
                 "pointerdown" === x ? (o = "pointermove", s = "pointerup") : "touchstart" === x ? (o = "touchmove", s = "touchend") : "MSPointerDown" === x ? (o = "MSPointerMove", s = "MSPointerUp") : (o = "mousemove", s = "mouseup"), o += g, s += g, this.transition(!0), this.panning = !0, this._trigger("start", t, i);
                 var _ = function (t, e) {
                     if (e) {
                         if (2 === e.length) {
                             if (null != a) return;
                             return a = d._getDistance(e), h = +m[0], void(c = d._getMiddle(e))
                         }
                         if (null != l) return;
                 ...
                 var M = function (t) {
                     var e;
                     if (t.preventDefault(), i = t.touches || t.originalEvent.touches, _(t, i), i) {
                         if (2 === i.length) {
                             var n = d._getMiddle(i),
                                 o = d._getDistance(i) - a;
                             return d.zoom(o * (p.increment / 100) + h, {
                                 focal: n,
                                 matrix: m,
                                 animate: "skip"
                             }), d.pan(+m[4] + n.clientX - c.clientX, +m[5] + n.clientY - c.clientY, b), void(c = n)
                         }
                         e = i[0] || {
                             pageX: 0,
                             pageY: 0
                 ...
                 e(r).off(g).on(o, M).on(s, function (t) {
                     t.preventDefault(), e(this).off(g), d.panning = !1, t.type = "panzoomend", d._trigger(t, m, !n(m, v))
                 })
             }
         }
     }, e.Panzoom = a, e.fn.panzoom = function (t) {
         var n, i, o, s;
         return "string" == typeof t ? (s = [], i = c.call(arguments, 1), this.each(function () {
             n = e.data(this, h), n ? "_" !== t.charAt(0) && "function" == typeof (o = n[t]) && void 0 !== (o = o.apply(n, i)) && s.push(o) : s.push(void 0)
         }), s.length ? 1 === s.length ? s[0] : s : this) : this.each(function () {
             new a(this, t)
         })
     }, a
 });